...
export class LinkedinPageComponent implements OnInit {
  ...
  linkedin() {
    window.location.replace("https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=86wrv2s8487eej&redirect_uri=http://localhost:9090/authorizeLinkedin&state=987654321&scope=r_basicprofile");
